...
try{
	...
	$stmtCheckToken=$con->prepare("SELECT tokens_table.user_id, tokens_table.access_token,tokens_table.block, user_data.user_type FROM tokens_table INNER JOIN user_data ON tokens_table.user_id=user_data.user_id where tokens_table.user_id=:var_user_id AND access_token=:var_access_token LIMIT 1");
