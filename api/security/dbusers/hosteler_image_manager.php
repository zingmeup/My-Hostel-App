...
try{
	...
	$stmtgetTypeOtp=$con->prepare("SELECT otp, outing_type FROM user_data WHERE user_id=:var_uid AND outing_type=:var_outing_type LIMIT 1");
	$stmtgetTypeOtp->bindParam(':var_uid', $GLOBALS['args']['UID']);
	$stmtgetTypeOtp->bindParam(':var_outing_type', $GLOBALS['args']['outing_type']);
