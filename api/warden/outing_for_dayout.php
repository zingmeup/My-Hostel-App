...
function getOutingsForDayout(){
  require $_SERVER['DOCUMENT_ROOT']."/api/warden/dbusers/outing_manager_warden.php";
  $stmtgetOutingsForDayout->execute();
  $stmtgetOutingsForDayout->setFetchMode(PDO::FETCH_ASSOC);
  $result=$stmtgetOutingsForDayout->fetchAll();
  $con=null;
